...
function periodPL(trades, fromStr){
  ...
  return { loss: net < 0 ? Math.abs(net) : 0, profit: net > 0 ? net : 0, net };
}
...
function viewPnL(){
  ...
  return `
    ...
    <div class="card">
      ...
      <div class="hint">این حساب‌ها بر اساس سود/ضرر خالص (net) همون بازه‌ست، نه جمع سودها یا جمع ضررها به‌تنهایی — یعنی اگه توی یه روز ۲۰ دلار سود و ۱۰ دلار ضرر کنی، «حد سود روزانه» فقط ۱۰ دلار (خالص) رو حساب می‌کنه، نه ۲۰. برای دقیق‌بودنش، فیلد «ریسک این معامله» رو توی ثبت معامله پر کن.</div>
    </div>
